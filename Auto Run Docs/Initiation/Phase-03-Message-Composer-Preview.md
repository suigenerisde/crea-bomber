...
- [ ] Create message type selector in src/components/messages/MessageTypeSelector.tsx:
...
- [ ] Create individual message form components in src/components/messages/:
...
- [ ] Create the main MessageComposer in src/components/messages/MessageComposer.tsx:
...
- [ ] Create macOS-style notification preview in src/components/preview/NotificationPreview.tsx:
...
- [ ] Create preview modal in src/components/preview/PreviewModal.tsx:
...
- [ ] Create video URL utilities in src/lib/video-utils.ts:
